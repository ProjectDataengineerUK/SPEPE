...
def train_pymc_model(
    ...
    logger.info(
        f"Sampling {draws} draws × {chains} chains (tune={tune}, target_accept={target_accept})..."
    )
    ...
    logger.info(
        f"Rhat max: {rhat_max:.4f}, ESS bulk min: {ess_bulk_min:.0f}, Divergences: {pct_divergent:.2f}%"
    )
...
if __name__ == "__main__":
    ...
    print("Model Version:      pymc-hierarchical-noncentered-v2")
